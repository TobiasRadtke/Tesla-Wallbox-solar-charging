...
String Settings() {
  ...
  page += " <p>SSID:<form action='/' method='POST'><input type='text' placeholder='SSID' name='SSID1'></p>";
  page += " <p>Password:<form action='/' method='POST'><input type='password' name='password1' placeholder='password'></p>";
  page += " <p>IP-Adress:<form action='/' method='POST'><input type='text' name='ipAdress1' placeholder='192'style='width:36px;'><input type='text' name='ipAdress2' placeholder='168'style='width:36px;'><input type='text' name='ipAdress3' placeholder='188'style='width:36px;'><input type='text' name='ipAdress4' placeholder='83'style='width:36px;'></p>";
  page += " <p>Port:<form action='/' method='POST'><input type='text' name='port1' placeholder='MODBUS Port'></p>";
  page += "<p>Current min Amps:";
  page += minAmpsToCharge;
  page += "</p>";
  page += "<p>Min Current:<form action='/' method='POST'><input type='range' name='currentSlider' min='6' max='12' step='1' style='width:200px;' value= '10' oninput='this.nextElementSibling.value = this.value'><output></output>";

  page += "</p>";
  page += "<p>Save:<form action='/' method='POST'><button class='btn btn-primary' type='button submit' name='save' value='1' style='background: rgb(32,234,76);'>Save</button><button class='btn btn-primary' type='button submit' name='exit' value='1' style='background: rgb(225,31,31);'>Exit</button></p>";
